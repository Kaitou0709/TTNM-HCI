...
namespace WebAPIcheck.Migrations
{
    ...
    [Migration("20230816085607_Tuitionfee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIcheck.Data.ExamSubjects", b =>
                {
                    b.Property<int>("IdExam")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdExam"));

                    b.Property<int>("IdEndTime")
                        .HasColumnType("int");

                    b.Property<int>("IdReSubject")
                        .HasColumnType("int");

                    b.Property<int>("IdStartTime")
                        .HasColumnType("int");

                    b.HasKey("IdExam");

                    b.HasIndex("IdReSubject");
            ...
            modelBuilder.Entity("WebAPIcheck.Data.FeeSubjects", b =>
                {
                    b.Property<int>("IdFee")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdFee"));
            ...
            modelBuilder.Entity("WebAPIcheck.Data.ReSubjects", b =>
                {
                    b.Property<int>("IdReSubject")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdReSubject"));
                    ...
                    b.HasKey("IdReSubject");

                    b.HasIndex("IdStudent");

                    b.HasIndex("IdSubject");

                    b.ToTable("ReSubjects");
                });
            ...
            modelBuilder.Entity("WebAPIcheck.Data.Score", b =>
                {
            ...
            modelBuilder.Entity("WebAPIcheck.Data.Tuitionfee", b =>
                {
                    b.Property<int>("IdTutionFee")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTutionFee"));
                    ...
                    b.Property<int>("MoneyTuition")
                        .HasColumnType("int");

                    b.HasKey("IdTutionFee");
            ...
            modelBuilder.Entity("WebAPIcheck.Data.ExamSubjects", b =>
                {
                    b.HasOne("WebAPIcheck.Data.ReSubjects", "ReSubject")
                        .WithMany()
                        .HasForeignKey("IdReSubject")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReSubject");
                });

            modelBuilder.Entity("WebAPIcheck.Data.FeeSubjects", b =>
                {
                    b.HasOne("WebAPIcheck.Data.Subjects", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPIcheck.Data.ReSubjects", b =>
                {
                    b.HasOne("WebAPIcheck.Data.Students", "Students")
                        .WithMany()
                        .HasForeignKey("IdStudent")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPIcheck.Data.SubjectsClass", "SubjectClass")
                        .WithMany()
                        .HasForeignKey("IdSubject")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebAPIcheck.Data.Score", b =>
                {
                    b.HasOne("WebAPIcheck.Data.ReSubjects", "ReSubjects")
                        .WithMany()
                        .HasForeignKey("IdReSubject")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReSubjects");
                });
